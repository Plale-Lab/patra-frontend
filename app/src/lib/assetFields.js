...
export const MODEL_CARD_SECTIONS = [
  {
    ...
    fields: [
      ...
      { key: 'creator_tapis_id', label: 'Creator Tapis ID', type: 'text', required: true, placeholder: 'e.g. swathivm', help: 'Defaults to your signed-in Tapis ID and can be edited.' },
      { key: 'creator_name', label: 'Creator Name', type: 'text', required: true, placeholder: 'e.g. Swathi Vallabhajosyula', help: 'Defaults to your Tapis ID and can be edited.' },
...
export const DATASHEET_SECTIONS = [
  ...
  },
  {
    ...
    title: 'DataCite',
    fields: [
      { key: 'author', label: 'Author', type: 'text', placeholder: 'e.g. Jane Doe', help: 'Comma-separated author names. Defaults to your name if left blank.' },
      { key: 'creator_tapis_id', label: 'Creator Tapis ID', type: 'text', required: true, placeholder: 'e.g. swathivm', help: 'Defaults to your signed-in Tapis ID and can be edited.' },
      { key: 'creator_name', label: 'Creator Name', type: 'text', required: true, placeholder: 'e.g. Swathi Vallabhajosyula', help: 'Defaults to your Tapis ID and can be edited.' },
