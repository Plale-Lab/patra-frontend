...
VITE_SUPPORTS_EDIT_EXISTING_ASSETS="${VITE_SUPPORTS_EDIT_EXISTING_ASSETS:-true}"
...
docker build \
  ...
  --build-arg VITE_SUPPORTS_EDIT_EXISTING_ASSETS="$VITE_SUPPORTS_EDIT_EXISTING_ASSETS" \
  -t "$IMAGE" .
