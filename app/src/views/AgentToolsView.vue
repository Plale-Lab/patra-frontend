<template>
  <div>
    <div class="page-header">
      <h1>Agent Tools</h1>
      <p>Run code-first schema extraction, public dataset-schema search, and strict missing-column feasibility analysis for PATRA substitution workflows.</p>
    </div>
    ...
    <div class="agent-layout">
      <div class="agent-main">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-helper block-helper">
                Provide exactly one source: a public document URL, a server-side file path, or pasted schema text. The PATRA backend extracts a query schema and ranks the public dataset-schema pool.
              </div>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  <label class="form-label">Server Document Path</label>
                  <input class="form-input" v-model="searchForm.documentPath" placeholder="D:\\data\\wheat_feature_schema.docx" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  rows="10"
                  placeholder="Paste a markdown table or JSON schema here"
                ></textarea>
              </div>
        ...
        <template v-else>
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-helper block-helper">
                This tool does not hallucinate values. It classifies each target field as directly available, derivable with provenance, or not safely derivable under the current deterministic rules.
              </div>
      ...
      <div class="agent-side">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="simple-list">
              <li>Schema search ranks public dataset-backed schemas and returns score-driven top-k candidates.</li>
              <li>Missing-column analysis only allows directly supported or auditable deterministic derivations.</li>
...
const candidateLookup = computed(() => {
  const items = {}
  schemaPool.value.forEach((item) => {
    items[item.dataset_id] = item
  })
  return items
})
...
async function handleSearch() {
  ...
  const provided = [
    ...
    Boolean(searchForm.documentPath.trim()),
    Boolean(searchForm.documentText.trim()),
  ].filter(Boolean).length

  if (provided !== 1) {
    errorMessage.value = 'Provide exactly one search source: document URL, server path, or pasted schema text.'
    return
  }
  ...
  try {
    const payload = {
      ...
      document_path: searchForm.documentPath.trim() || null,
